...
\section{El problema de transporte}
 {
  ...
  \section{El Baricentro de Wasserstein}\label{sec:el-baricentro-de-Wasserstein}
  {
	  \FM[inline]{Mencionar las geodésicas en el espacio de Wasserstein}
	  \FM[inline]{Hablar sobre la media de Frechet y como generaliza la noción de promedio}
	  \FM[inline]{Definir el baricentro de Wasserstein}
	  \FM[inline]{Generalizar al continuo}
