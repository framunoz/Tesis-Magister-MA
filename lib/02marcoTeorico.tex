...
\begin{definition}[Operador push-forward]\label{def:operador-push-forward}
...
\RED[inline]{Se podría volver a revisar la redacción de esta sección.}

Esta sección presenta el concepto de baricentro de Wasserstein, el cual es una generalización del concepto de promedio para medidas de probabilidad. Este concepto será clave para definir el baricentro de Wasserstein Bayesiano, el cual será el principal objeto de estudio de esta tesis. Para ello, se empieza revisando el concepto de media de Fréchet, para continuar por definir el baricentro de Wasserstein, revisar técnicas de cálculo de baricentros de población, y terminar definiendo el baricentro de Wasserstein Bayesiano. La escritura de esta sección se basó en ejemplos de la Sección 3 de Panaretos y Zemel \cite{panaretos2020invitation} y en definiciones de la Sección 9.2 de Peyré y Cuturi \cite{peyre2019computational}.
...
\RED[inline]{Esta sección quedó muy difícil de leer, quizás hay que acortarla más o mejorarla.}
...
Se terminará esta sección presentando el algoritmo del BSGDW, pues es esta la versión más general. El siguiente algoritmo es una adaptación de la presentada en \cite{backhoff2022bayesian}, en donde se utiliza la Observación~\ref{rem:bsgdw}.
