...
En base al trabajo \cite{zhu2016generative}, donde describe la manera en que una GAN aproxima una variedad de imágenes, y como se puede utilizar un AE para proyectar una imagen en esta variedad\RED{Esto ya lo comenté al principio, será necesario volver a comentarlo?}, los autores de \cite{simon2020barycenters} proponen utilizar una GAN y un AE para mantener la suavidad y realismo de la interpolación.
